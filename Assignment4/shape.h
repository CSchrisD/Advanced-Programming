...
class text: public shape {
   ...
   public:
      ...
      virtual void draw (const vertex&, const rgbcolor&,
       const bool& select) const override;
...
class rectangle: public polygon {
   public:
      ...
      virtual void draw (const vertex& center,
        const rgbcolor& color,const bool& select) const override;
};
...
//
// Classes Triangle, etc.
//
class triangle: public polygon {
   public:
      triangle (GLfloat x0, GLfloat y0, GLfloat x1,
